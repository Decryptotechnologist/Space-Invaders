...
import com.spaceinvaders.graphics.Star;
...
public class MainMenu extends JMenuBar {
    ...
    public MainMenu(Game game) {
        ...
        fileMenu.setMnemonic(KeyEvent.VK_G);
            ...
            //newMi.setDisplayedMnemonicIndex(1);
        ...
        editMenu.setMnemonic(KeyEvent.VK_E);
            ...
            //EDIT : DEFAULT KEYS
            JMenuItem defaultKeysMi = new JMenuItem("Keys", optionsIcon);
            defaultKeysMi.setMnemonic(KeyEvent.VK_Y);
            KeyStroke y = KeyStroke.getKeyStroke(KeyEvent.VK_Y, 0);
            defaultKeysMi.setAccelerator(y);

            defaultKeysMi.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent event) {
                    Sound.btnPushed.play();
                    game.setKeys();
        ...
        viewMenu.setMnemonic(KeyEvent.VK_V);
            ...
            sbarMi.setMnemonic(KeyEvent.VK_Z);
            ...
            sUpsMi.setMnemonic(KeyEvent.VK_P);
            ...
            sboundsMi.setMnemonic(KeyEvent.VK_B);
            ...
            sKillshotMi.setMnemonic(KeyEvent.VK_K);
            ...
            sHUDMi.setMnemonic(KeyEvent.VK_U);
            ...
            sHUDMi.addItemListener(new ItemListener() {
                ...
                public void itemStateChanged(ItemEvent e) {
                    ...
                    if (e.getStateChange() == ItemEvent.SELECTED) {
                        Sound.btnPushed.play();
                        Display.showHUD = true;
                    } else {
                        Sound.btnPushed.play();
                        Display.showHUD = false;
                    }
            ...
            //VIEW : SHOW SPACE
            JCheckBoxMenuItem sSpaceMi = new JCheckBoxMenuItem("Show Space", sfxIcon);
            sSpaceMi.setMnemonic(KeyEvent.VK_0);
            KeyStroke zero = KeyStroke.getKeyStroke(KeyEvent.VK_0, 0);
            sSpaceMi.setAccelerator(zero);
            if(game.showSpace){
                sSpaceMi.setSelected(true);
            } else {
                sSpaceMi.setSelected(false);
            }

            sSpaceMi.addItemListener(new ItemListener() {
            ...
            //VIEW : SHOW STARS
            JCheckBoxMenuItem sStarsMi = new JCheckBoxMenuItem("Show Stars", sfxIcon);
            sStarsMi.setMnemonic(KeyEvent.VK_1);
            KeyStroke one = KeyStroke.getKeyStroke(KeyEvent.VK_1, 0);
            sStarsMi.setAccelerator(one);
            sStarsMi.setSelected(true);

            sStarsMi.addItemListener(new ItemListener() {
        ...
        devMenu.setMnemonic(KeyEvent.VK_D);
        ...
        playerMenu.setMnemonic(KeyEvent.VK_P);
            ...
            rapidFireMi.setMnemonic(KeyEvent.VK_R);
        ...
        viewMenu.add(sSpaceMi);
        viewMenu.add(sStarsMi);
