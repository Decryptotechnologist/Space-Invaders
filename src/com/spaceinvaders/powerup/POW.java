...
public class POW {
    ...
    /**x variable of POW object*/
    public int x;
    
    /**y variable of POW object*/
    public int y;
    
    /**width variable of POW Rectangle object*/
    public static int pow_w;// = 40;
    
    /**height variable of POW Rectangle object*/
    public static int pow_h;// = 40;
    
    /**width variable of POW object*/
    public int width;
    
    /**height variable of POW object*/
    public int height;
    
    /**speed variable of POW object*/
    public static int speed;
    
    /**visibility variable of POW object*/
    public boolean visible;
    
    /**isDead variable of POW object*/
    public boolean isDead;
    
    /**suit variable of POW object*/
    public int suit;
    
    /**random variable of POW object*/
    public static Random random;
    
    /**cannonPOWz List variable of POW object*/
    public static List<cannonPOW> cannonPOWz = new ArrayList<>();
    
    /**cannonPOWzA List variable of POW object*/
    public static List<cannonPOW> cannonPOWzA;
    
    /**shieldPOWz List variable of POW object*/
    public static List<shieldPOW> shieldPOWz = new ArrayList<>();
    
    /**shieldPOWzA List variable of POW object*/
    public static List<shieldPOW> shieldPOWzA;
    
    /**speedPOWz List variable of POW object*/
    public static List<speedPOW> speedPOWz = new ArrayList<>();
    
    /**speedPOWzA List variable of POW object*/
    public static List<speedPOW> speedPOWzA;
    
    /**extraLifePOWz List variable of POW object*/
    public static List<extraLifePOW> extraLifePOWz = new ArrayList<>();
    
    /**extraLifePOWzA List variable of POW object*/
     ...
     */
    private void setUP() {
        int screenWidth = Game.getGameWidth();
        switch(screenWidth){
            case 300:
                pow_w = 25;
                pow_h = 25;
